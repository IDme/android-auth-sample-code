 ...
 */
class GroupsRequest(configuration: IDmeConfiguration) {
    val url: String
    val state: String
    val nonce: String?
    ...
    init {
        if (configuration.environment != IDmeEnvironment.PRODUCTION) {
        ...
        val params = mutableListOf(
            ...
            "scopes" to IDmeScope.groupsString(configuration.scopes),
            "state" to state
        )
        ...
        val baseUrl = APIEndpoint.groups(configuration.environment)
